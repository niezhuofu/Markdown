...
object PermissionUtils {
    ...
    val requestPermissions = arrayOf(PERMISSION_RECORD_AUDIO, PERMISSION_GET_ACCOUNTS, PERMISSION_READ_PHONE_STATE, PERMISSION_CALL_PHONE, PERMISSION_CAMERA, PERMISSION_ACCESS_FINE_LOCATION, PERMISSION_ACCESS_COARSE_LOCATION, PERMISSION_READ_EXTERNAL_STORAGE, PERMISSION_WRITE_EXTERNAL_STORAGE)
    ...
    fun requestPermission(activity: Activity?, requestCode: Int, permissionGrant: PermissionGrant) {
        ...
        try {
            ...
            Toast.makeText(activity, "为保证应用正常允许，请打开相应权限。", Toast.LENGTH_SHORT)
                    .show()
    ...
    open fun requestMultiResult(activity: Activity?, permissions: Array<String>, grantResults: IntArray, permissionGrant: PermissionGrant) {
        ...
        if (notGranted.size == 0) {
            ...
            openSettingActivity(activity, "为保证应用正常运行，请授权相应权限。")
        }
