...
import com.chad.library.R2;
import com.chad.library.adapter.base.utils.Check;
import com.chad.library.adapter.base.utils.Network;
import com.chad.library.adapter.base.utils.SystemBarUtils;
import com.chad.library.adapter.base.utils.SystemUtils;
...
public class BaseWebActivity extends BaseToolbarActivity {
    ...
    public final void onCreateAfter(Bundle savedInstanceState) {
        ...
        if (mProgressBar != null)
            mProgressBar.setReachedBarColor(getResources().getColor(R.color.colorPrimary));
