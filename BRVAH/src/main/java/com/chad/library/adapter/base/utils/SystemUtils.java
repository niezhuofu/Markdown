...
public class SystemUtils {
    ...
    public static void showSoftKeyboard(View view) {
        ((InputMethodManager)MyApplication.Companion.context().getSystemService(Context.INPUT_METHOD_SERVICE))
    ...
    public static int getStatusBarHeight() {
        ...
        if (MyApplication.Companion.context() == null) {
            return 0;
        }
        Class<?> c;
        Object obj;
        ...
        try {
            ...
            barHeight = MyApplication.Companion.context().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
