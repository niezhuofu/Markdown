...
import static com.nzf.markdown.view.MaterialMenuDrawable.DEFAULT_COLOR;
import static com.nzf.markdown.view.MaterialMenuDrawable.DEFAULT_SCALE;
import static com.nzf.markdown.view.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
import static com.nzf.markdown.view.MaterialMenuDrawable.DEFAULT_VISIBLE;
import static com.nzf.markdown.view.MaterialMenuDrawable.IconState;
/**
...
public class MaterialMenuView extends View implements MaterialMenu {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            switch (state) {
                case 0:
                    currentState = MaterialMenuDrawable.IconState.BURGER;
                    break;
                case 1:
                    currentState = MaterialMenuDrawable.IconState.ARROW;
                    break;
                case 2:
                    currentState = MaterialMenuDrawable.IconState.X;
                    break;
                case 3:
                    currentState = MaterialMenuDrawable.IconState.CHECK;
                    break;
            }
    ...
    @Override public MaterialMenuDrawable.IconState setTransformationOffset(MaterialMenuDrawable.AnimationState animationState, float value) {
